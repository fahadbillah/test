...
if(isset($_REQUEST["query"])){
  $query = $all_requisitions->sanitize_query($_REQUEST["query"]);
  //echo $query; 
}
$type = $_REQUEST['type'];
    ...
    <body>
     ...
     <div class="container">
      ...
      switch($type){
       ...
       break;
       case 'search':
       $requisition = $all_requisitions->search_requisition($query,$user_id,$tempStart,$perpage);
       $typeHeader = 'Searched';
       $icon = "icon-search";
       $total = $all_requisitions->req_data;  
       break;						
     ...
     if($requisition!==NULL){
      ...
      <div class="span10 well well-large">
       ...
       <div class="span9 well well-small" style=" text-align: center"><strong><?php echo "Total ".$typeHeader." Requisition - ".$total; ?></strong></div>
       <table class="table table-striped">
         ...
         <div class="pagination" style="text-align:center">
           <ul>
             <?php
             isset($_REQUEST["query"])? $url_extra = "&query=".$query : $url_extra = "";
             if(isset($page))                    
             {                                      
              ...
              {					
                ...
                echo "<li><a id='page_a_link' href='all_requisitions.php?page=$j&type=".$type.$url_extra."'><< Prev</a></li>";					
              }
              ...
              {					
                if($i<>$page)					
                {					
                  echo "<li><a href='all_requisitions.php?page=$i&type=".$type.$url_extra."' id='page_a_link'>$i</a></li>";					
                }					
                else					
                {					
              ...
              {					
                ...
                echo "<li><a href='all_requisitions.php?page=$j&type=".$type.$url_extra."' id='page_a_link'>Next >></a></li>";					
              }					
            }
          }
          ?>
