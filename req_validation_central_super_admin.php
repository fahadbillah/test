          ...
          <div id="yooo">
		  	<?php 
				...
				if(isset($_REQUEST['decision1'])){
			   		$req_list->change_req_activities(35,$_REQUEST["id"],$_REQUEST['decision1']);
			   		$req_list->change_req_status(35,$_REQUEST["id"],$_REQUEST['decision1']);
			   		$req_list->change_req_status_main($_REQUEST["id"],$_REQUEST['decision1']);
			   		//$req_list->redirect_to_dept($_REQUEST["id"], 'Accounts');					
				}
				...
				$req_list->get_req_log($_REQUEST["id"]);
			?>
			 ...
			 ?>
               ...
               <tr>
				 ...
				 ?>
                 <td>
                 <form id="des" name="des" action="req_validation_central_super_admin.php?id=<?php echo $id ?>" method="post" onSubmit="reassure()">
