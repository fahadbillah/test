      ...
      <div class="navbar-inner">
        ...
        <div class="container">
          ...
          <div class="well well-large">
             <h4>All Staff from Location <?php echo $super_admin->convert_id_location($_SESSION["location"])?></h4>
             <table class="table table-striped">
             <ul>   
             <?php 
			 	unset($super_admin->user_data);
				$super_admin->get_user_by_locations($_SESSION["location"]);
				  if($super_admin->user_data!=NULL){
					 foreach($super_admin->user_data as $user)
					 {
						extract($user);
			  ?>  
              <tr> 
              <td>        
               <li>
                 <?php 
				 	echo"<a href='profile.php?id=".$id."&read_status=read'>".$name."</a>";
				?>  
               </li>
               </td>
               <td>
               ...
               <?php 
					 	...
					 	echo "<span class='label label-warning'>No staff is found under this location.</span>";
			}
		  ?>                
             </ul>
             </table>
