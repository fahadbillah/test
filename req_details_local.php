  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
          ...
          <div id="yooo">
		  	<?php 
				...
				if(isset($_REQUEST['decision1'])){
			   		$req_list->change_req_activities(28,$_REQUEST["id"],$_REQUEST['decision1']);
			   		$req_list->change_req_status(28,$_REQUEST["id"],$_REQUEST['decision1']);
			...
			?>
			 ...
			 ?>
				 ...
				 <?php
				 	switch($status)
					{
						...
						case "New":						
							...
							break;
						case "Solved":						
							echo "<button class='btn btn-small btn-primary disabled' type='button'>Solved</button>";
							break;
						case "Closed":						
               ...
               <tr>
				 ...
				 ?>
                 <td>
                 <form id="des" name="des" action="req_details_local.php?id=<?php echo $id ?>" method="post" onSubmit="reassure()">
                     <button class="btn btn-small btn-success" type="submit" id="decision" name="decision1" value="Solved">Solved</button>
        ...
        <br>
        <br>
        <form id="pm" name="pm" class="form-horizontal" action="req_details_local.php?id=<?php echo $_REQUEST["id"] ?>" method="post">
