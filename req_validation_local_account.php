          ...
          <div id="yooo">
		  	<?php 
				...
				if(isset($_REQUEST['decision1'])){
			   		$req_list->change_req_activities(25,$_REQUEST["id"],$_REQUEST['decision1']);
			   		$req_list->change_req_status(25,$_REQUEST["id"],$_REQUEST['decision1']);
			   		$req_list->change_req_status_main($_REQUEST["id"],$_REQUEST['decision1']);
				}
				if(isset($_REQUEST['dSolved'])){
			   		$req_list->change_req_activities(25,$_REQUEST["id"],$_REQUEST['dSolved']);
			   		$req_list->change_req_status(25,$_REQUEST["id"],$_REQUEST['dSolved']);
			...
			?>
			 ...
			 ?>
				 ...
				 <?php
				 	switch($status)
					{
						...
						case "Modify":						
							...
							break;
						case "Solved":						
							echo "<button class='btn btn-small btn-danger disabled' type='button'>Solved</button>";
							break;
						case "Closed":						
               ...
               <tr>
				 ...
				 ?>
                 <td>
                 <form id="des" name="des" action="req_validation_local_account.php?id=<?php echo $id ?>" method="post" onSubmit="reassure()">
				 ...
				 ?>   
                 <td>
                 <form id="solved" name="solved" action="req_validation_local_account.php?id=<?php echo $id ?>" method="post" onSubmit="reassure()">
