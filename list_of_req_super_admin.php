      ...
      <div class="navbar-inner">
        ...
        <div class="container">
          ...
          <?php 
				...
				if($req_list->check_any_req_in_table())
				{
			...
			?>
			 ...
			 echo $_SESSION["idusers"];
			 	$req_list->admin_req_list($_SESSION["idusers"],$start,$perpage);
               ...
               <tr>								
                 ...
                 <td>
					...
					if($req_list->new_comment_available($id,$_SESSION["idusers"])>0)
						echo " ".$req_list->additional_data." new <i class='icon-comment'></i> ";
					?>
                 </td>
                 ...
                 <td class="pagination">
                   <ul>
                    ...
                    
                    {
                        ...
                        $req_list->total_user_req_list($_SESSION['idusers'],"admin");
                    ...
                    //echo $req_list->req_data;
                        ...
                        {					
                            ...
                            echo "<li><a id='page_a_link' href='list_of_req_super_admin.php?page=$j'><< Prev</a></li>";					
                        }
                        ...
                        {					
                            if($i<>$page)					
                            {					
                                echo "<li><a href='list_of_req_super_admin.php?page=$i' id='page_a_link'>$i</a></li>";					
                            }					
                            else					
                            {					
                        ...
                        {					
                            ...
                            echo "<li><a href='list_of_req_super_admin.php?page=$j' id='page_a_link'>Next >></a></li>";					
                        }					
                    }  
				}
                    ?>
