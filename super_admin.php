<?php 
	...
	if(!isset($_SESSION["autorizatin_level"]))
		$_SESSION["autorizatin_level"] = 'local approval';
        ...
        <div class="container">
          ...
          <div class="well well-large">
             ...
             <?php 
				...
				$super_admin->super_admin_req_list_by_location(0,10,"New",$_SESSION["location"]);
				  if($super_admin->goog_to_go_flag>0){
			  ...
			  ?>           
               <li>
                 <?php 
				 	echo"<a href='req_validation.php?id=".$id."&read_status=read'>$title</a>";
          ...
          <div class="well well-large">
             ...
             <?php 
			 	unset($super_admin->req_data);
				//$super_admin->super_admin_req_list_by_type(0,3,"Pending",$_SESSION["idusers"]);
				$super_admin->super_admin_req_list_by_location(0,10,"Pending",$_SESSION["location"]);
				  if($super_admin->goog_to_go_flag>0){
					 foreach($super_admin->req_data as $list)
					 {
						extract($list);
			  ?>           
               <li>
                 <?php 
				 	echo"<a href='req_validation.php?id=".$id."'>$title</a>";
				/*	if($super_admin->new_comment_available($id,$_SESSION["idusers"])>0)
						echo " ".$super_admin->additional_data." new <i class='icon-comment'></i> ";   */
				?>  
               </li>  
          ...
          <div class="well well-large">
             ...
             <?php 
			 	unset($super_admin->req_data);
				//$super_admin->super_admin_req_list_by_type(0,3,"Solved",$_SESSION["idusers"]);
				$super_admin->super_admin_req_list_by_location(0,10,"Solved",$_SESSION["location"]);
				  if($super_admin->goog_to_go_flag>0){
					 foreach($super_admin->req_data as $list)
					 {
						extract($list);
          ...
          <div class="well well-large">
             <h3>Sent for Modification</h3>
             <ul>    
             <?php 
			 	unset($super_admin->req_data);
				//$super_admin->super_admin_req_list_by_type(0,3,"Modify",$_SESSION["idusers"]);
				$super_admin->super_admin_req_list_by_location(0,10,"Modify",$_SESSION["location"]);
				  if($super_admin->goog_to_go_flag>0){
					 foreach($super_admin->req_data as $list)
					 {
						extract($list);
