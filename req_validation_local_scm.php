          ...
          <div id="yooo">
		  	<?php 
				...
				if(isset($_REQUEST['decision1'])){
			   		$req_list->change_req_activities(26,$_REQUEST["id"],$_REQUEST['decision1']);
			   		$req_list->change_req_status(26,$_REQUEST["id"],$_REQUEST['decision1']);
			...
			?>
			 ...
			 ?>
               ...
               <tr>
				 ...
				 ?>
                 <td>
                 <form id="des" name="des" action="req_validation_local_scm.php?id=<?php echo $id ?>" method="post" onSubmit="reassure()">
