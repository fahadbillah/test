...
<div class="container">
    <div class="page-header">
        <h2>Step 2: Upload user photo</h2>
    </div>
    <div class="well">
        <h3>Instructions</h3>
        <ul>
            <li>The maximum file size for uploads is <strong>10 MB</strong>.</li>
            <li>Mentioned file types (<strong>JPG, GIF, PNG, TXT, DOC, DOCX, PDF</strong>) are allowed.</li>
    ...
    <form id="fileupload" action="server/php/index.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="user_id" value="73">
        ...
        <div class="row fileupload-buttonbar">
            ...
            <div class="row">
                <input type="hidden" name="recent_user" value="
				<?php 
					if(isset($_REQUEST["id"]))  
						echo $_REQUEST["id"];
					else
						echo $_SESSION["recent_add_user"];
				?>">
            </div>
