...
class UploadHandler
{
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
            $index = null, $content_range = null, $upload_type = null) {
        $file = new stdClass();
	...
	function add_img($whichimg)
	{
		...
		$add_to_db = $this->query("UPDATE users SET image='$whichimg' where idusers = $id") or die(mysql_error());
		return $add_to_db;
	}/*$query="UPDATE users SET name='$name', contact='$contact', designation='$designation', department='$department' 
		where idusers='$id'";*/
	
	function delete_img($delimg)
	{
		$delete_from_db = $this->query("UPDATE users SET image='' where image = '$delimg'") or die(mysql_error());
