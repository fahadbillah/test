  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
          ...
          <div id="yooo">
		  	<?php 
				...
				if(isset($_REQUEST['decision1'])){
			   		$req_list->add_activity_central(37,$_REQUEST["id"],$_REQUEST['decision1']);
			...
			?>
			 ...
			 ?>
               ...
               <tr>
                 <th>Decision</th>
                 <?php 
				 if($status==='Clear From Accounts'){					 
				 ?>
                 <td>
                 <form id="des" name="des" action="req_validation_central_scm.php?id=<?php echo $id ?>" method="post" onSubmit="reassure()">
                     <button class="btn btn-small btn-success" type="submit" id="decision" name="decision1" value="Delivered">Delivered</button>
        ...
        <br>
        <br>
        <form id="pm" name="pm" class="form-horizontal" action="req_validation_central_scm.php?id=<?php echo $_REQUEST["id"] ?>" method="post">
