  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li><a href="list_of_req_user.php">Requisition</a></li>
        ...
        <div class="container">
          ...
          <?php 
				...
				if(isset($_REQUEST["submit"]))
				{
					...
					if(!in_array("",$_REQUEST))
					{
						...
						if(filter_var($costing, FILTER_VALIDATE_INT))
						{
							...
							$id = $new_req_type->new_req_type($_SESSION["idusers"],$title,$description,$type_of_req,$recurring_recurring,$costing,$datepicker);
			...
			?>
			  ...
			  <form id="new_req_type_form" name="new_req_type_form" class="form-horizontal" action="add_new_req_type.php" method="post">              
              ...
              <div class="control-group">
                <label class="control-label" for="recurring_recurring">Department</label>
                <div class="controls">
                  <select name="department" onChange="select_exec()">
                    <option value="">Select Department</option>
                        <?php
							unset($new_req_type->req_data);
							$new_req_type->get_destination(); 
							foreach($new_req_type->req_data as $data)
							{
								extract($data);	
						?>	
    ...
    * { font-family: Verdana; font-size: 98%; }
	...
	function select_exec(){
		  $.post('select_exec.php', {id: new_req_type_form.department.value},
              function(output){
                  $('#select_executive').html(output).show();
              });
